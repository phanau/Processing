...
int unsignedInt(byte low, byte high) {
    ...
    //print("unsignedInt: ");print(uLow);print(":");print(uHigh);print("=");println(a);
    return a;
}
...
Packet GetPacket() {
  ...
  { print("<"); delay(10); }
  //print("G2a-");print(myPort.available());print(":");print(packetLen);print(";");
